...
/**
 * merge_sort - Writing a fxn that sorts an array
...
void merge_sort(int *array, size_t size)
{
	...
	merge_recursion(srt, array, 0, size);
	free(srt);
}

/**
 * merge_recursion - Writing a recursive fxn that merge sorts an array
 * @arr: copy array
...
/**
 * merge_subarray - Writing a fxn that merges subarrays
 * @arr: copy array
